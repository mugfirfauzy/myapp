    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('category.update', [$category->id, 'type'=>'update']) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
